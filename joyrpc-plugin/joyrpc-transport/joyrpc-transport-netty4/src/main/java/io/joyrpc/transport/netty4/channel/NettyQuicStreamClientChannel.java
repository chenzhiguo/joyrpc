 ...
 * 客户端Channel
 */
public class NettyQuicStreamClientChannel extends NettyQuicChannel {
     ...
     * @param ioGroup 线程池
     */
    public NettyQuicStreamClientChannel(final io.netty.channel.Channel channel, final EventLoopGroup ioGroup) {
