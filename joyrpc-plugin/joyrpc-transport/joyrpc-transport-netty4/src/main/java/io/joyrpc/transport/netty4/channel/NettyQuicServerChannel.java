 ...
 * @date: 2019/3/6
 */
public class NettyQuicServerChannel extends NettyQuicChannel implements ServerChannel {
     ...
     * @param supplier
     */
    public NettyQuicServerChannel(final io.netty.channel.Channel channel,
                                  final EventLoopGroup bossGroup,
                                  final EventLoopGroup workerGroup,
                                  final Supplier<List<Channel>> supplier) {
        super(channel, true, null);
