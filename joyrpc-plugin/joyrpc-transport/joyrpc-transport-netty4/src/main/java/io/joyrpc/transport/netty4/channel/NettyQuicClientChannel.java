 ...
 * 客户端Channel
 */
public class NettyQuicClientChannel extends NettyQuicChannel {
     ...
     * @param ioGroup 线程池
     */
    public NettyQuicClientChannel(final io.netty.channel.Channel channel, final EventLoopGroup ioGroup, final Function<io.netty.channel.Channel,io.netty.channel.Channel> streamChannelFunction) {
        super(channel, false, streamChannelFunction);
